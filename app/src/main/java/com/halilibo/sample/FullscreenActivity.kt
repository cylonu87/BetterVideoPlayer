...
class FullscreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBetterVideoPlayer.setSource(Uri.parse("android.resource://" + packageName + "/" + com.halilibo.sample.R.raw.video))

        mBetterVideoPlayer.getToolbar().title = "FullScreen Sample"
